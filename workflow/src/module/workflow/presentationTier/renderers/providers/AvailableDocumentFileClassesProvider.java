 ...
 * 
 */
public class AvailableDocumentFileClassesProvider implements DataProvider {
	...
	WorkflowDocumentUploadBean bean = (WorkflowDocumentUploadBean) source;
	WorkflowProcess process = bean.getProcess();
	return process.getUploadableFileDocumentTypes();
    }
