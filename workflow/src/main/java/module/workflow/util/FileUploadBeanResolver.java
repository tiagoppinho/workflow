...
public class FileUploadBeanResolver {
    ...
    private static Map<Class<? extends ProcessFile>, Class<? extends WorkflowFileUploadBean>> beanMap =
            new HashMap<Class<? extends ProcessFile>, Class<? extends WorkflowFileUploadBean>>();
