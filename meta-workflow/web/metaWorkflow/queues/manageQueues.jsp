...
<fr:view name="queues" schema="view.queues.details">
	<fr:layout name="tabular">
		...
		<fr:property name="linkFormat(view)" value="/metaWorkflowQueueManagement.do?method=viewQueue&queueId=${externalId}"/>
		<fr:property name="key(view)" value="link.view"/>
		<fr:property name="bundle(view)" value="MYORG_RESOURCES"/>
		
		<fr:property name="linkFormat(edit)" value="/metaWorkflowQueueManagement.do?method=prepareEditQueue&queueId=${externalId}"/>
